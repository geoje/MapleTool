...
export const EFFECT_COUNT_PER_CRYSTAL = CRYSTALS_BY_LEVEL[1][0].effects[0].length; // 3
...
export const MAX_CRYSTAL_LEVEL = CRYSTALS_BY_LEVEL[CRYSTALS_BY_LEVEL.length - 1][0].level; // 5
