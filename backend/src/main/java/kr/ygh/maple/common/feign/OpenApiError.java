...
public enum OpenApiError {
    ...
    INVALID_IDENTIFIER("OPENAPI00003", HttpStatus.INTERNAL_SERVER_ERROR, "접속한지 오래 되었거나 유요하지 않은 식별자입니다."),
    INVALID_PARAMETER("OPENAPI00004", HttpStatus.BAD_REQUEST, "캐릭터가 존재하지 않거나 유요하지 않은 요청입니다."),
